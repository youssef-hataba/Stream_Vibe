    ...
    <div className="space-y-6 mt-3">
      {loading ? (
        ...
        filteredReviews.map((review, index) => {
          const name = review.author.name;
          const rating =
            review.source === "tmdb" ? (review.author.rating / 2).toFixed(1) : review.author.rating;
          ...
          const displayedText = isExpanded ? content : content.slice(0, MAX_REVIEW_LENGTH);

          return (
            <div
              key={review.id || index}
              className="bg-black-10 p-4 rounded-lg border border-black-15 shadow-md">
              ...
              <p className="text-sm text-gray-300 leading-relaxed">
                ...
                {shouldTruncate && (
                  <span
                    ...
                    className="ml-1 text-yellow-600 cursor-pointer hover:underline">
